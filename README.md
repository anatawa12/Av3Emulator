...
![Lock your inspector to allow investigating other objects](.readme/lock_inspector_tutorial.png)![Checklist for turning off Write Defaults.](.readme/write_defaults_off.png)
[(View full lock inspector explanation)](.readme/lock_inspector_tutorial.png) [(View full write defaults off checklist)](.readme/write_defaults_off.png)
